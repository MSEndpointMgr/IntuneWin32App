function Update-IntuneWin32App {
    ...
    param(
        ...
        [parameter(Mandatory = $false, ParameterSetName = "MSI", HelpMessage = "The ID of the existing application.")]
        [parameter(Mandatory = $false, ParameterSetName = "EXE")]
        [ValidateNotNullOrEmpty()]
        ...
        try {
            ...
            if ($IntuneWinXMLMetaData -ne $null) {
                ...
                if ($Win32MobileAppRequest.'@odata.type' -notlike "#microsoft.graph.win32LobApp") {
                    ...
                    Write-Verbose -Message "Successfully created Win32 app with ID: $ApplicationId"
                    ...
                    $Win32MobileAppContentVersionRequest = Invoke-IntuneGraphRequest -APIVersion "Beta" -Resource "mobileApps/$ApplicationId/microsoft.graph.win32LobApp/contentVersions" -Method "POST" -Body "{}"
                    if ([string]::IsNullOrEmpty($Win32MobileAppContentVersionRequest.id)) {
                        ...
                        if ($IntuneWinFilePath -ne $null) {
                            ...
                            $Win32MobileAppFileContentRequest = Invoke-IntuneGraphRequest -APIVersion "Beta" -Resource "mobileApps/$ApplicationId/microsoft.graph.win32LobApp/contentVersions/$($Win32MobileAppContentVersionRequest.id)/files" -Method "POST" -Body ($Win32AppFileBody | ConvertTo-Json)
                            if ([string]::IsNullOrEmpty($Win32MobileAppFileContentRequest.id)) {
                                ...
                                $FilesUri = "mobileApps/$ApplicationId/microsoft.graph.win32LobApp/contentVersions/$($Win32MobileAppContentVersionRequest.id)/files/$($Win32MobileAppFileContentRequest.id)"
                                ...
                                $CommitResource = "mobileApps/$ApplicationId/microsoft.graph.win32LobApp/contentVersions/$($Win32MobileAppContentVersionRequest.id)/files/$($Win32MobileAppFileContentRequest.id)/commit"
                                ...
                                $Win32AppFileCommitBodyRequest = Invoke-IntuneGraphRequest -APIVersion "Beta" -Resource "mobileApps/$ApplicationId" -Method "PATCH" -Body ($Win32AppFileCommitBody | ConvertTo-Json)
                                ...
                                $Win32MobileAppRequest = Invoke-IntuneGraphRequest -APIVersion "Beta" -Resource "mobileApps/$ApplicationId" -Method "GET"
