function New-IntuneWin32AppDetectionRuleRegistry {
    <#
    .SYNOPSIS
        Create a new registry type of detection rule object to be used for the Add-IntuneWin32App function.
    ...
    .PARAMETER StringComparison
        Define that the detection rule will be based on a specific string comparison.

    .PARAMETER IntegerComparison
        Define that the detection rule will be based on an integer comparison.

    .PARAMETER VersionComparison
        Define that the detection rule will be based on a version comparison.
    ...
    param(
        ...
        [parameter(Mandatory = $true, ParameterSetName = "StringComparison", HelpMessage = "Define that the detection rule will be based on a specific string comparison.")]
        [switch]$StringComparison,

        [parameter(Mandatory = $true, ParameterSetName = "VersionComparison", HelpMessage = "Define that the detection rule will be based on a version comparison.")]
        [switch]$VersionComparison,

        [parameter(Mandatory = $true, ParameterSetName = "IntegerComparison", HelpMessage = "Define that the detection rule will be based on an integer comparison.")]
